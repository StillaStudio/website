      ...
      <main className="min-h-screen bg-black text-white flex flex-col">
        <div className="flex-1 flex items-center justify-center px-6">
          <div className="text-center max-w-2xl">
            <h1 className="text-5xl md:text-6xl font-light mb-16 serif">{t('title')}</h1>
            <p className="text-xl mb-8 font-light">
              {t.rich('description', {
                email: (chunks) => <span className="font-medium">{chunks}</span>
              })}
            </p>
            <a href="mailto:hello@still-a-studio.com" className="text-xl underline hover:opacity-70 transition-opacity">
